...
namespace Asv.Mavlink.Client
{
    public interface IMavlinkCommandClient
    {
        ...
        /// <param name="cancel"></param>
        /// <returns></returns>
        Task SendCommandLong(MavCmd command, float param1, float param2, float param3, float param4, float param5, float param6, float param7, int attemptCount, CancellationToken cancel);
