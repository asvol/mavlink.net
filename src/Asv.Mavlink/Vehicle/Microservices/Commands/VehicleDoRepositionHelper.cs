...
namespace Asv.Mavlink
{
    public static class VehicleDoRepositionHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static Task<CommandAckPayload> DoReposition(this IVehicle src, float groundSpeed, GeoPoint newPosition, CancellationToken cancel)
        {
        ...
        public static async Task DoRepositionMoveUp(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
            var loc = vehicle.Rtt.RelGps.Value;
        ...
        public static async Task DoRepositionDown(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
            var loc = vehicle.Rtt.RelGps.Value;
            loc = loc.AddAltitude(-moveDistance);
            await vehicle.DoReposition((float)moveVelocity, loc, cancel);
        ...
        public static Task DoRepositionMoveN(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
            return DoRepositionMoveToRadialPoint(vehicle, moveDistance, moveVelocity, 0, cancel);
        }

        public static Task DoRepositionMoveE(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
            return DoRepositionMoveToRadialPoint(vehicle, moveDistance, moveVelocity, 90, cancel);
        }

        public static Task DoRepositionMoveW(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
            return DoRepositionMoveToRadialPoint(vehicle, moveDistance, moveVelocity, 270, cancel);
        }

        public static Task DoRepositionMoveS(this IVehicle vehicle, double moveDistance, double moveVelocity, CancellationToken cancel)
        {
